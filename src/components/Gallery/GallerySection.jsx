    ...
    <section className="ctu-gallery">
      <header>
        <h1 className="text-5xl font-extralight text-gray-900 tracking-wide text-center mb-12">
          Every building at CTU, covered
        </h1>
        <p className="text-xl font-medium text-gray-900 tracking-wide text-center mb-12">
          What do you want to find on ATIN Map Directory
        </p>
      </header>
